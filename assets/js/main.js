...
$("#submit-form").submit((e) => {
  e.preventDefault()
  $.ajax({
    url: "https://script.google.com/macros/s/AKfycbwIKHE_pkmmJ7dfzbUNktQEntoX3RcYyrFV9XKf6b1LjqKiNPTA6LD2dIXTeQpsSuNUrw/exec",
...
function validateName() {
  ...
  if (!nameField.match((/^[A-Za-z]+\s{1}[A-Za-z]+$/))) {
    nameError.innerHTML = "Write Your Full Name (First Name & Last Name)";
...
function validateEmail() {
  ...
  if (!emailField.match(/^[A-Za-z\._\-0-9]*[@][A-Za-z]*[\.][a-z]{2,4}$/)) {
    emailError.innerHTML = "Invalid e-mail Id";
    return false;
  } else {
